...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LOCATIONEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LOCATIONEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LOCATIONEVENT actions', async () => {
      const arg = { id: 15249 };
    ...
    it('dispatches UPDATE_LOCATIONEVENT actions', async () => {
      const arg = { id: 15249 };
    ...
    it('dispatches PARTIAL_UPDATE_LOCATIONEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LOCATIONEVENT actions', async () => {
      const arg = 42666;
