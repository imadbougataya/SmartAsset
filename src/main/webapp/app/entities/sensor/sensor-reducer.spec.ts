...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './sensor.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SENSOR_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SENSOR actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SENSOR actions', async () => {
      const arg = { id: 25244 };
    ...
    it('dispatches UPDATE_SENSOR actions', async () => {
      const arg = { id: 25244 };
    ...
    it('dispatches PARTIAL_UPDATE_SENSOR actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SENSOR actions', async () => {
      const arg = 42666;
