...
import reducer, {
  ...
  reset,
  updateEntity,
} from './maintenance-event.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_MAINTENANCEEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_MAINTENANCEEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_MAINTENANCEEVENT actions', async () => {
      const arg = { id: 25527 };
    ...
    it('dispatches UPDATE_MAINTENANCEEVENT actions', async () => {
      const arg = { id: 25527 };
    ...
    it('dispatches PARTIAL_UPDATE_MAINTENANCEEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_MAINTENANCEEVENT actions', async () => {
      const arg = 42666;
