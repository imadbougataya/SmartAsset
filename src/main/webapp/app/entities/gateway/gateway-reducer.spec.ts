...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './gateway.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_GATEWAY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_GATEWAY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_GATEWAY actions', async () => {
      const arg = { id: 3011 };
    ...
    it('dispatches UPDATE_GATEWAY actions', async () => {
      const arg = { id: 3011 };
    ...
    it('dispatches PARTIAL_UPDATE_GATEWAY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_GATEWAY actions', async () => {
      const arg = 42666;
