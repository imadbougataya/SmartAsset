...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SYSTEMEVENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SYSTEMEVENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SYSTEMEVENT actions', async () => {
      const arg = { id: 30830 };
    ...
    it('dispatches UPDATE_SYSTEMEVENT actions', async () => {
      const arg = { id: 30830 };
    ...
    it('dispatches PARTIAL_UPDATE_SYSTEMEVENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SYSTEMEVENT actions', async () => {
      const arg = 42666;
