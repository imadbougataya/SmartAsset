...
import reducer, {
  ...
  reset,
  updateEntity,
} from './asset-movement-request.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSETMOVEMENTREQUEST_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ASSETMOVEMENTREQUEST actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ASSETMOVEMENTREQUEST actions', async () => {
      const arg = { id: 17294 };
    ...
    it('dispatches UPDATE_ASSETMOVEMENTREQUEST actions', async () => {
      const arg = { id: 17294 };
    ...
    it('dispatches PARTIAL_UPDATE_ASSETMOVEMENTREQUEST actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ASSETMOVEMENTREQUEST actions', async () => {
      const arg = 42666;
