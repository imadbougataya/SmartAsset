...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DOCUMENTLINK_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_DOCUMENTLINK actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_DOCUMENTLINK actions', async () => {
      const arg = { id: 3323 };
    ...
    it('dispatches UPDATE_DOCUMENTLINK actions', async () => {
      const arg = { id: 3323 };
    ...
    it('dispatches PARTIAL_UPDATE_DOCUMENTLINK actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_DOCUMENTLINK actions', async () => {
      const arg = 42666;
