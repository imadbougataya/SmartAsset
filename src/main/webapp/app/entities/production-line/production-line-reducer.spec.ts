...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PRODUCTIONLINE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_PRODUCTIONLINE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_PRODUCTIONLINE actions', async () => {
      const arg = { id: 668 };
    ...
    it('dispatches UPDATE_PRODUCTIONLINE actions', async () => {
      const arg = { id: 668 };
    ...
    it('dispatches PARTIAL_UPDATE_PRODUCTIONLINE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_PRODUCTIONLINE actions', async () => {
      const arg = 42666;
