...
import reducer, {
  ...
  reset,
  updateEntity,
} from './sensor-measurement.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SENSORMEASUREMENT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_SENSORMEASUREMENT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_SENSORMEASUREMENT actions', async () => {
      const arg = { id: 32398 };
    ...
    it('dispatches UPDATE_SENSORMEASUREMENT actions', async () => {
      const arg = { id: 32398 };
    ...
    it('dispatches PARTIAL_UPDATE_SENSORMEASUREMENT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_SENSORMEASUREMENT actions', async () => {
      const arg = 42666;
